...
@section('content')
  <div class="w3-container w3-metro-blue">
    <h2>Formularz dodania informacji o projekcie</h>
  </div>
  <form action="/projects" method="POST" class="w3-container w3-margin-top">
  @csrf
    <label for="innert_project_number">Numer wewnętrzny projektu</label>
    <input name="innert_project_number" id="innert_project_number" type="text" class="w3-input"/>
    
    <label for="project_number">Numer projektu</label>
    <input name="project_number" id="project_number" type="text" class="w3-input"/>
    
    <label for="title">Tytuł projektu</label>
    <input name="title" id="title" type="text" class="w3-input"/>

...
@section('content')
  <div class="w3-container w3-metro-blue">
    <h2>Formularz dodania nowego urządzenia do realizacji badań</h>
  </div>
  <form action="/equipment" method="POST" class="w3-container w3-margin-top">
  @csrf
    <label for="acronim">Akronim:</label>

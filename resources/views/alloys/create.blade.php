...
@section('content')
  <div class="w3-container w3-metro-blue">
    <h2>Formularz dodania nowego metalu lub stopu</h>
  </div>
  <form action="/alloys" method="POST" class="w3-container w3-margin-top">
  @csrf
    <label for="symbol">Symbol metalu lub stopu:</label>
